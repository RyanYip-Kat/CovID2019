...
genes<-topn$gene
jpeg(file.path(args$outdir,"HCER_heatmap1.jpeg"),width=1024,height=1024)
DoHeatmap(seurat,features=genes)
dev.off()

jpeg(file.path(args$outdir,"HCER_heatmap2.jpeg"),width=1024,height=1024)
...
jpeg(file.path(args$outdir,"HCER_heatmap3.jpeg"),width=1024,height=1024)
pheatmap.idents(seurat,genes)
dev.off()

jpeg(file.path(args$outdir,"HCER_heatmap4.jpeg"),width=1024,height=1024)
