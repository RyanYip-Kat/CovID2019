...
down_markers<-subset(markers,cluster=="ER" & logFC > 0)
down_markers$logFC<- -down_markers$logFC
up_markers<-subset(markers,cluster=="TR" & logFC > 0)
...
jpeg(file.path(args$outdir,"ER_TR_volcano_plot.jpeg"),width = 1024,height=1024)
