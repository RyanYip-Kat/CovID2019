...
path="/Data/zoc/result/PBMC/10X-count/10X-VDJ/human/5RNA/UVR-3-RNA-5RNA/outs"
...
#cluster<-subset(cluster,select=Cluster,Cluster%in%c(2,4,5,6,10)) # T
cluster<-subset(cluster,select=Cluster,Cluster%in%c(2,4,5,6,10,1)) # NKT
