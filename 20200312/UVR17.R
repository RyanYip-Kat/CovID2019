...
path="/Data/zoc/result/PBMC/10X-count/10X-VDJ/human/5RNA/UVR-17-5RNA/outs"
...
cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,4,6,10)) #  T
#cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,4,6,10,3)) # NKT
