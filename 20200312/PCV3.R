...
path="/Data/zoc/result/PBMC/10X-count/10X-VDJ/human/5RNA/PCV-3-RNA-5RNA/outs"
...
#cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,4,5,8, 9,14)) # T
cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,4,5,7,8, 9,13,14)) #NKT
