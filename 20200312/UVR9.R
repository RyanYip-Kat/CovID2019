...
path="/Data/zoc/result/PBMC/10X-count/10X-VDJ/human/5RNA/UVR-9-5RNA/outs"
...
#cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,6,7,9)) # T
cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,6,7,9,2,8)) # NKT
