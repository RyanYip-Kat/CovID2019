...
path="/Data/zoc/result/PBMC/10X-count/10X-VDJ/human/5RNA/UVR-16-5RNA/outs"
...
cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,4,5)) # T
#cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,4,5,9)) # NKT
