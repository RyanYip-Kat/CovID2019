...
path="/Data/zoc/result/PBMC/10X-count/10X-VDJ/human/5RNA/PCV-2-RNA-5RNA/outs"
...
#cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,4,12,13)) # T 
cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,2,4,12,13)) # NKT
