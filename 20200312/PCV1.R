...
path="/Data/zoc/result/PBMC/10X-count/10X-VDJ/human/5RNA/PCV-1-5RNA/outs"
...
#cluster<-subset(cluster,select=Cluster,Cluster%in%c(2,3,5,9)) # T
cluster<-subset(cluster,select=Cluster,Cluster%in%c(1,2,3,5,9,6)) # NKT
