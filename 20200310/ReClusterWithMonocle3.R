...
jpeg(file.path(args$outdir,"20200301_new_umap_clusters.jpeg"),width=1024,height=1024)
...
saveRDS(markers,file.path(args$outdir,"20200310_new_markers.rds"))
write.table(topn,file.path(args$outdir,"20200310_new_top70_markers.csv"),quote=F,row.names=F,sep=",")
