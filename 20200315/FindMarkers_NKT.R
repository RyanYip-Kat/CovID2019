...
#seurat<-subset(seurat,idents=c(1,5)) #NK
#seurat<-subset(seurat,idents=c(3,4,7,9,10,16)) # CD4
#seurat<-subset(seurat,idents=c(11,12,13,14,2,6,8)) #  CD8
seurat<-subset(seurat,idents=c(15)) # ValueAdd
