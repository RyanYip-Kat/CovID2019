...
#seurat<-subset(seurat,idents=c(1,2,4,6,9)) # CD14
#seurat<-subset(seurat,idents=c(5,11,12)) # CD16
#seurat<-subset(seurat,idents=c(10,13,15)) #DC
seurat<-subset(seurat,idents=c(3,7,8,14)) # Med
